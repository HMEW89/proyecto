...
?>
                                    <form class="" action="<?php echo base_url();?>index.php/servicio/modificarbd" method="post" novalidate>
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" value="<?php echo $row->costo;?>" type="number"  name="costo" required='required'  /></div>
                                        </div>
